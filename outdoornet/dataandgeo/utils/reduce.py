...
from outdoornet.dataandgeo.utils import reduce_value
from outdoornet.dataandgeo.utils import prepare_dataset_prefix
...
def all_reduce_metrics(output_data_batch, datasets, name='depth'):
    """
    Reduce metrics for all batches and all dataandgeo using Horovod
    ...
    datasets : list
        List of all considered dataandgeo
    name : str
    ...
    # print(output_data_batch[0][0].keys())
    # print(name)
    ...
    # List storing metrics for all dataandgeo
    all_metrics_dict = []
    # Loop over all dataandgeo and all batches
