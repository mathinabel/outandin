...
from outdoornet.dataandgeo.utils import make_list, same_shape
from outdoornet.dataandgeo.utils import pcolor
from outdoornet.dataandgeo.utils import print0
from outdoornet.dataandgeo.utils.types import is_str
...
def backwards_state_dict(state_dict):
    """
    Modify the state dict of older model for backwards compatibility
