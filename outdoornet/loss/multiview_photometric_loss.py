...
from outdoornet.dataandgeo.utils import match_scales
from outdoornet.dataandgeo.camera import Camera
from outdoornet.dataandgeo.camera_utils import view_synthesis
from outdoornet.dataandgeo.utils import calc_smoothness, inv2depth
from outdoornet.loss.loss_base import LossBase, ProgressiveScaling
...
########################################################################################################################
    ...
    def reduce_photometric_loss(self, photometric_losses):
        ...
        photometric_losses : list of torch.Tensor [B,3,H,W]
            Pixel-wise photometric loss from the entire context
