...
def sync_s3_data(local, model):
    """Sync saved model with the s3 bucket"""
...
class ModelCheckpoint:
    def __init__(self, filepath=None, monitor='val_loss',
        ...
        super().__init__()
        # If save_top_k is zero, save all model
        if save_top_k == 0:
            save_top_k = 1e6
